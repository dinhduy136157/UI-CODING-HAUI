...
import { FaArrowLeft, FaCode, FaCheckCircle, FaTimesCircle, FaClock } from "react-icons/fa";
...
export default function CodingExerciseScores() {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [classId]); // classId được lấy từ useParams()
  ...
  const getLatestSubmissionForExercise = (exerciseId) => {
    ...
    return exerciseSubmissions[0]; // Trả về bài nộp mới nhất
  };
  ...
  const completedExercises = submissions.filter(s => s.status === "Accepted").length;
      ...
      <main className="flex-1 p-6">
        ...
        <section className="mt-6">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow">
              <h3 className="text-gray-500 font-medium">Đã nộp</h3>
